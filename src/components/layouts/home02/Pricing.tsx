...
function Pricing() {
  ...
  return (
    <section className="pricing section-padding mt-4" id="pricing">
      <div className="container">
        ...
        <div className="row ">
          {state.pricing.map((data, index) => (
            <div className="col-lg-4 col-md-6" key={index}>
              <div className="pricing-item mb-4 mb-lg-0 shadow rounded" key={data.id}>
                ...
                <ul className="pricing-features">
                  <li>
                    <i className={data.icon}></i> {data.list1}
                  </li>
                  <li>
                    <i className={data.icon}></i> {data.list2}
                  </li>
                  <li>
                    <i className={data.icon}></i> {data.list3}
                  </li>
                  <li>
                    <i className={data.icon}></i> {data.list4}
                  </li>
                </ul>

                <div className="pricing-footer">
                  <Link to="#" className="btn btn-main-2">
                    Get it now
                  </Link>
                </div>
              </div>
